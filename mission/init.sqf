...
if (isnull gPilot || isnull gInf) then {
  ...
  [[
    ...
    ["About","Meant to be played with least amount of UI cheating, Expert difficulty preferred. There is no predefined extraction zone the players need to find. Mission will end once all the troops are in the rescue chopper and it's at least 1km from the wreck.<br /><br />Custom view distance actions, if chosen, will be automatically removed after 3 minutes.<br /><br />Version: 20131003<br />Made by: Shuko of LDD Kyllikki<br />Contact: shuko@Quakenet<br />www.kyllikki.fi<br /><br /><img image='lddk.jpg' width='100' height='100'>"]
  ]] call compile preprocessfile "SHK_taskmaster.sqf";
};
